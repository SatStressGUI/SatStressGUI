...
class PolarWander(StressDef): #{{{
    ...
    def __init__(self, satellite):
        ...
        self.Flattening = ((self.radius())**3 * Omega**2) / (2.0 * pc.G * self.mass()) * self.h2
        ...
        self.thetaRInitial = 0 + scipy.pi/2 #Converts to colatitude
        self.thetaRFinal = 0 + scipy.pi/2 #Converts to colatitude
        self.phiRInitial = 0
        self.phiRFinal = 0
        ...
        self.UserAdjust = 0 #A factor for the difference between the polar axis and the Jovian axis
        #If 0, assumes the axes are perpendicular.
        #Positive means the angle between them is obtuse.
        #Negative means the angle between them is acute.
        
        self.thetaTInitial = 0 + scipy.pi/2 #Converts to colatitude
        self.thetaTFinal = 0 + scipy.pi/2 #Converts to colatitude
        self.phiTInitial = self.phiRInitial + self.UserAdjust
        self.phiTFinal = self.phiRFinal + self.UserAdjust
