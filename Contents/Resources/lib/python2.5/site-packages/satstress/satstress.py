...
class PolarWander(StressDef): #{{{
    ...
    def Ttt(self, theta, phi, t):
        ...
        RDi = (6 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2))**2) + (9 * self.CosGamma(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2)**2) - 5 #Calculates the stress from the initial position of the pole
        RDf = (6 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2))**2) + (9 * self.CosGamma(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2)**2) - 5 #Calculates the stress from the reorientation of the pole
        TDi = (6 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2))**2) + (9 * self.CosGamma(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2)**2) - 5 #Calculates the stress from the initial tidal deformation
        TDf = (6 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2))**2) + (9 * self.CosGamma(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2)**2) - 5 #Calculates the stress from the final tidal deformation
        ...
        #This commented equation is an extremely simplified version.
    ...
    def Tpp(self, theta, phi, t):
        ...
        RDi = (-6.0 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2))**2) + (3.0 * (self.CosGamma(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2))**2) + 1.0 #Calculates the stress from the initial position of the pole
        RDf = (-6.0 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2))**2) + (3.0 * (self.CosGamma(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2))**2) + 1.0 #Calculates the stress from the reorientation of the pole
        TDi = (-6.0 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2))**2) + (3.0 * (self.CosGamma(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2))**2) + 1.0 #Calculates the stress from the initial tidal deformation
        TDf = (-6.0 * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2))**2) + (3.0 * (self.CosGamma(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2))**2) + 1.0 #Calculates the stress from the final tidal deformation
    ...
    def Tpt(self, theta, phi, t):
        ...
        RDi = 2.0 * (self.SinGammaSinPsi(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2)) * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ri, phi_Ri - scipy.pi/2)) #Calculates the stress from the initial position of the pole
        RDf = 2.0 * (self.SinGammaSinPsi(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2)) * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Rf, phi_Rf - scipy.pi/2)) #Calculates the stress from the reorientation of the pole
        TDi = 2.0 * (self.SinGammaSinPsi(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2)) * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Ti, phi_Ti - scipy.pi/2)) #Calculates the stress from the initial tidal deformation
        TDf = 2.0 * (self.SinGammaSinPsi(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2)) * (self.SinGammaCosPsi(theta, phi - scipy.pi/2, theta_Tf, phi_Tf - scipy.pi/2)) #Calculates the stress from the final tidal deformation
