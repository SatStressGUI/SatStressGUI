...
class PW_Variables(object): #
  ...
  def __init__(self, thetaRi=0, phiRi=0, thetaRf=0, phiRf=0, thetaTi=0, phiTi=0, thetaTf=0, phiTf=0):
    self.thetaRInitial = thetaRi + scipy.pi/2
    self.phiRInitial = phiRi
    self.thetaRFinal = thetaRf + scipy.pi/2
    self.phiRFinal = phiRf
    self.thetaTInitial = thetaTi + scipy.pi/2
    self.phiTInitial = phiTi
  ...
  def __str__(self):
    return("thetaRi = %s, phiRi = %s\nthetaRf = %s, phiRf = %s\nthetaTi = %s, phiTi = %s\nthetaTf = %s, phiTf = %s" %
      (self.thetaRi, self.phiRi, self.thetaRf, self.phiRf, self.thetaTi, self.phiTi, self.thetaTf, self.phiTf))
