...
class StressDef(object): #{{{
    ...
    useUser = False
    loveUser = LoveNum()
    scparameters = self.scparameters
...
class PolarWander(StressDef): #{{{
    ...
    def __init__(self, satellite):
        ...
        self.thetaRInitial = scparameters['PWthetaRi']
        self.phiRInitial = scparameters['PWphiRi']
        self.thetaRFinal = scparameters['PWthetaRf']
        self.phiRFinal = scparameters['PWphiRf']
        self.thetaTInitial = scparameters['PWthetaTi']
        self.phiTInitial = scparameters['PWphiTi']
...
class StressCalc(object): #{{{
    ...
    def __init__(self, stressdefs, satelliteparameters):
        """
        ...
        self.scparameters = satelliteparameters #Sets the satellite parameters to what the user inputs
        print '1', self.scparameters
